...
verify(topThreeWords("a a a  b  c c  d d d d  e e e e e"), ["e", "d", "a"]);

verify(topThreeWords("a a c b b"), ["a", "b", "c"]);

verify(topThreeWords("e e e e DDD ddd DdD: ddd ddd aa aA Aa, bb cc cC e e e"), [
  "e",
  "ddd",
  "aa",
]);

verify(topThreeWords("  //wont won't won't "), ["won't", "wont"]);

verify(topThreeWords("  , e   .. "), ["e"]);

verify(topThreeWords("  ...  "), []);
